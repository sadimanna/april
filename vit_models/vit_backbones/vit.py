...
from models.torch_encodings import PositionalEncoding1D #, PositionalEncodingPermute1D, get_emb
...
class Embeddings(nn.Module):
    ...
    def __init__(self, config, img_size, in_channels=3):
        ...
        self.patch_embeddings = Conv2d(in_channels=in_channels,
                                       ...
                                       stride=patch_size)
        self.position_embeddings = nn.Parameter(torch.zeros(1, n_patches+1, config.hidden_size)) # PositionalEncoding1D(config.hidden_size) #nn.Parameter(torch.zeros(1, n_patches+1, config.hidden_size))
